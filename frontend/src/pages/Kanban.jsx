...
function KanbanCard({ lead, salesUsers, isManager, meId }) {
  ...
  const currency = '₹'
  const value = currency + ' ' + ((lead.expected_value ?? 0).toLocaleString('en-GB'))
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="text-xs text-slate-600 inline-flex items-center gap-1"><Calendar size={12} /> {nfa ? nfa.toLocaleDateString('en-GB') : '-'}</div>
